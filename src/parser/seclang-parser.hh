...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_ACTION_REMOVE_SETVAR = 428, // "RemoveSetVar"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_ACTION_REMOVE_SETVAR = 173,            // "RemoveSetVar"
        S_ACTION_ID = 174,                       // "Id"
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_ACTION_REMOVE_SETVAR: // "RemoveSetVar"
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_ACTION_REMOVE_SETVAR (std::string v, location_type l)
      {
        return symbol_type (token::TOK_ACTION_REMOVE_SETVAR, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ACTION_REMOVE_SETVAR (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_ACTION_REMOVE_SETVAR, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    enum
    {
      yylast_ = 3419,     ///< Last index in yytable_.
